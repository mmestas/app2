...
//******************* GET PATIENT INFO FOR DASHBOARD ********************/
  ...
  $scope.getCompletedCases = function () {
    commonFnSrvc.getCompletedCases($scope);
  };
...
$scope.gotocase = function (casefile) {
  authSrvc.goToProviderPatientDetails(casefile, $scope.selected);
};
          ...
          if (response.errors.length > 0) {
              ...
              upload({
                  ...
                  .then(function (response) {
                      ...
                      $state.go('new-case.step-1', {id: $scope.newCasefile2.id});
                  });
          }
      });
  };
